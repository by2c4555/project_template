---
name: Builder200K
description: Execute one bounded task under the 200K Builder context profile using the shared Builder Task Execution skill.
...
```text
Context ceiling:          200K
Preferred working set:   <= 120K
Maximum planned task:    <= 150K
...
If planned context exceeds 153600 tokens or is `SPLIT_REQUIRED`, do not execute it as one Task under this profile.
