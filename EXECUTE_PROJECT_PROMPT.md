...
The user then manually runs `start_evaluation.py` and launches External Agent Evaluation. A passing Evaluation is closed only by `finalize_evaluation.py` after a Completion Report exists.
