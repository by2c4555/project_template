...
required=[
    ...
    'Workplan/MIGRATION_V5_2_TO_V5_3.md','Workplan/MIGRATION_V5_3_0_TO_V5_3_1.md','Workplan/RELEASE_VALIDATION.md','Workplan/FILE_SHA256SUMS.txt',
    ...
    'Workplan/scripts/command.py','Workplan/scripts/resume.py','Workplan/scripts/approve.py','Workplan/scripts/integrity.py','Workplan/scripts/migrate_v530_to_v531.py',
    ...
    'Workplan/tests/run_command_protocol.py','Workplan/tests/run_v53_invariants.py','Workplan/tests/run_v531_hardening.py','Workplan/tests/run_v531_acceptance.py','Workplan/tests/run_scenarios.py','Workplan/tests/run_recovery_scenario.py',
...
contains('README.md',['Project Template v5.3.1','Cycle -> Phase -> Task -> Attempt','WORKPLAN_NEXT','Project Builder Local','EXTERNAL_RESEARCH_PROTOCOL_V1','MIGRATION_V5_3_0_TO_V5_3_1.md'])
contains('Workplan/Objective_dev.md',['v5.3.1','Cycle -> Phase -> Task -> Attempt','External Recovery is reasoning-only','Public command authority is exact-token authority','Integrity manifest is generated deterministically'])
contains('Workplan/ENTRY_PROMPT.md',['v5.3.1','exact literal token','EXECUTE_IMPLEMENTATION','EXECUTE_RECOVERY','WORKPLAN_NEXT'])
...
contains('.github/agents/manager.agent.md',['v5.3.1',"agents: ['Builder']",'no production `edit`','Task Gate','Phase Gate'])
contains('.github/agents/builder.agent.md',['Builder — Project Template v5.3.1',"model: 'Project Builder Local'",'Task', 'Repair', 'Recovery Ticket'])
...
# Canonical v5.3.1 release files replace obsolete duplicate/compatibility paths.
for rel in [
...
print('STRUCTURAL_VALID: PASS (v5.3.1 schema 6)')

if '--full' in sys.argv:
    suites=[
        ('command_protocol','Workplan/tests/run_command_protocol.py'),
        ('v53_invariants','Workplan/tests/run_v53_invariants.py'),
        ('v531_hardening','Workplan/tests/run_v531_hardening.py'),
        ('v531_final_acceptance','Workplan/tests/run_v531_acceptance.py'),
    ...
    if failed:
        ...
        raise SystemExit(1)
    print('TEMPLATE_VALID: PASS (v5.3.1 --full)')
else:
    print('TEMPLATE_VALID: PASS (v5.3.1 structural)')
