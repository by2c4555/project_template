...
if task and task in ex.get('tasks',{}): ex['tasks'][task]['status']='PASS_RECOVERED'; ex['active_issue']=None; ex['status']='READY'; cycle['execution']=ex; st['lifecycle_stage']='EXECUTION'; st['project_state']='EXECUTION'; st['next_action']='RESUME_EXECUTION_MANAGER'
else: st['lifecycle_stage']='EVALUATION'; st['project_state']='EVALUATION'; st['next_action']='RUN_EXTERNAL_AGENT_EVALUATION'
st['cycles'][cid]=cycle; save_state(st,event='RECOVERY_VERIFIED',actor='tool:recovery',details={'issue':issue['issue_id'],'baseline':a.baseline}); print('RECOVERY: VERIFIED'); print('next_stage:',st['lifecycle_stage'])
