...
st['cycles'][cid]=cycle; st['active_cycle']=cid; st['project_state']='PLANNING'; st['lifecycle_stage']='PLANNING'; st['next_action']='RUN_EXTERNAL_AGENT_PLANNING'; save_state(st,event='SCOPE_IMPORTED',actor='tool:scope',details={'cycle_id':cid,'ingest_id':r['ingest_id'],'scope_digest':r['scope_digest']})
print('SCOPE_IMPORT: PASS'); print('cycle:',cid); print('scope_revision:',rev); print('scope_digest:',r['scope_digest']); print('next: python Workplan/scripts/tools/external.py acquire --tool <tool> --model <model>')
