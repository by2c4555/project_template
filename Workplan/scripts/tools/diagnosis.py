...
if a.classification=='IMPLEMENTATION_DEFECT': st['lifecycle_stage']='RECOVERY'; st['project_state']='RECOVERY'; st['next_action']='EXECUTE_RECOVERY'
elif a.classification in {'TASK_DEFECT','PLAN_DEFECT'}: st['lifecycle_stage']='PLANNING'; st['project_state']='PLANNING'; st['next_action']='EXECUTE_PLANNING'
