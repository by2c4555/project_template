...
Inputs:
- latest `EXECUTE/evaluation/Evaluation_Vx.md`
- latest `EXECUTE/evaluation/RESEARCH_HANDOFF_Vx.md`
- current `EXECUTE/project_details.md`
- existing `EXECUTE/docs/raw/**`
- user decisions/clarifications

Goal: produce Research Vx+1 by resolving evidence-backed knowledge gaps, not by directly patching implementation.
