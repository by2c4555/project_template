# Planning & Approval Control Contract — v4.4.0
...
3. `AWAITING_MATERIAL_FEEDBACK` and `PLAN_READY` are terminal states for the current External Agent invocation.
4. The External Agent Planning role may call machine planning gates, but may never call human approval gates.
