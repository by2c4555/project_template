...
It is distinct from `EXECUTE/reference/KNOWLEDGE_INDEX.md`, which stores Codex-prepared project/requirement/architecture knowledge for the current planning package.
...
- Codex Planning must inspect this index before finalizing a plan.
- Codex Evaluation must inspect relevant prior resolutions when designing targeted regression checks.
