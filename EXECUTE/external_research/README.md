# External Research Pack — v4.4.0

This folder is for **ChatGPT Projects or any other web-AI project/workspace** used outside the controlled VS Code runtime.

Its job is to turn an idea/change/debug intent into a concise implementation-ready scope plus useful evidence for External Agent Planning.
...
These working files are **not** the Planning handoff.
...
There is no `Research_Vx.md` in v4.4.0.
...
Python validates the handoff and captures an immutable Scope Snapshot before External Agent Planning begins.
