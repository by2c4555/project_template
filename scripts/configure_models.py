...
def main():
    ap = argparse.ArgumentParser(
        description='Configure v4.3.1 local model bindings from EXECUTE/MODEL_CONFIG.ini. CLI flags optionally override file values.'
    )
    ...
    print('v4.3.1 local model bindings configured.')
