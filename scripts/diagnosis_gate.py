#!/usr/bin/env python3
"""Register an immutable External Agent diagnosis and route the active issue without granting repair authority."""
from __future__ import annotations
import argparse, hashlib
from pathlib import Path
from workflow_state import ROOT, active_cycle, append_transition, load_state, save_state, utc_now, require_external_work_complete
...
a=ap.parse_args()
state=load_state(); cid,cycle=active_cycle(state); require_external_work_complete(state,cycle,'DIAGNOSIS')
...
if a.classification=='IMPLEMENTATION_DEFECT':
    ...
    rec['status']='CONTINUE_DIAGNOSIS'; cycle['lifecycle_stage']='DIAGNOSIS'; cycle['next_action']='CONTINUE_EXTERNAL_AGENT_DIAGNOSIS'
