#!/usr/bin/env python3
"""Start a new v4.3.2 change cycle by capturing the external handoff as SCOPE_001."""
...
ap = argparse.ArgumentParser(description='Start a new v4.3.2 change cycle from EXECUTE/project_details.md + declared docs/raw evidence.')
